...
#SBATCH --workdir=/lscr2/andersenlab/mzy668/celegans/SRNA/5-BWA3
#SBATCH --mem=10096

bwa aln -o 0 -n 3 -t 8 ../../N2_genome/c_elegans.PRJNA13758.WS255.genomic.fa ../2-FastQ_q1/N2_q1.fq.gz > N2.sai
...
samtools sort -@ 8 -o N2.bam N2.unsorted.bam
samtools index -b N2.bam

bwa aln -o 0 -n 3 -t 8 ../../N2_genome/c_elegans.PRJNA13758.WS255.genomic.fa ../2-FastQ_q1/N2-P_q1.fq.gz > N2P.sai
...
samtools sort -@ 8 -o N2P.bam N2P.unsorted.bam
samtools index -b N2P.bam

bwa aln -o 0 -n 3 -t 8 ../../CB4856_genome/Caenorhabditis_elegans_CB4856_v1.0.fa ../2-FastQ_q1/CB_q1.fq.gz > CB.sai
...
samtools sort -@ 8 -o CB.bam CB.unsorted.bam
samtools index -b CB.bam

bwa aln -o 0 -n 3 -t 8 ../../CB4856_genome/Caenorhabditis_elegans_CB4856_v1.0.fa ../2-FastQ_q1/CB-P_q1.fq.gz > CBP.sai
...
samtools sort -@ 8 -o CBP.bam CBP.unsorted.bam
